...
<?php endforeach; ?>
<?php
echo '<label style="float: left;">Fecha Empaquetado</label><span class="field float"><input  id ="fechaDespacho" class="input-small fecha" type="text" name="data[MovimientoInventario][Fecha]" required="required" /><small><em>   yyyy / mm / dd</em></small></span>';
...
<table  id="listaArticulos" class ="table table-bordered" width="100%"  style="width: 100%;">
	...
	<tbody>
        ...
        <tr id ="<?php echo $articulo['det']['IdArticulo']?>">
            ...
            <td><img style="width:250px; height:150px;border-style:solid;border-width:3px;" src="/InvenPolka/app/webroot/files/articulo/idFoto/<?php echo $articulo['art']['dir']; ?>/small_<?php echo $articulo['art']['idFoto']; ?>" alt="CakePHP" ></td>
        </tr>
        <?php endforeach; ?>
