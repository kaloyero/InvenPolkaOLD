...
<?php
echo $this->Form->input('Nombre',array('class'=>'input-medium','div'=>false,'label'=>false,'before'=>'<p><label style="display: inline-block; padding: 20px 0 0 45px; vertical-align: middle; text-align: left; font-weight: bold;">Nombre</label><span class="field">','after'=>'</span></p>'));
?>
