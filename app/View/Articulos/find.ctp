...
echo $this->Form->input('ArticuloSearch.IdEstilo',array('type'=>'select','options'=>$estilos,'empty'=>true,'class'=>'uniformselect'																								,'div'=>false,'label'=>false,'before'=>' Estilo : '));
...
echo $this->Form->input('ArticuloSearch.IdDecorado',array('type'=>'select','options'=>$decorados,'empty'=>true,'class'=>'uniformselect'																								,'div'=>false,'label'=>false,'before'=>' Decorado : ','after'=>'</span></p>'));
