...
echo '<span id="preview" class="field"><img src="/InvenPolka/app/webroot/files/articulo/idFoto/'.$this->data['Articulo']['dir'].'/'.$this->data['Articulo']['idFoto'] .' "alt="CakePHP" height="800px" width="800px"></span>';
