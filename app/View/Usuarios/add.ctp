...
echo $this->Form->input('password',array('class'=>'input-medium','maxlength'=>'16','div'=>false,'label'=>false,'before'=>'<label style="float: left;">Clave</label><span  class="field float">','after'=>'</span>'));
...
echo $this->Form->input('Apellido',array('class'=>'input-medium','div'=>false,'label'=>false,'before'=>'<label style="float: left;">Apellido</label><span  class="field float">','after'=>'</span>'));

echo $this->Form->input('Legajo',array('class'=>'input-medium','div'=>false,'label'=>false,'before'=>'<label style="float: left;">Legajo</label><span  class="field float">','after'=>'</span></p>'));
