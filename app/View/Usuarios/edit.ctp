...
echo $this->Form->input('Nombre',array('class'=>'input-medium','div'=>false,'label'=>false,'before'=>'<label style="float: left;">Nombre</label><span  class="field float">','after'=>'</span></p>'));
...
echo $this->Form->input('Legajo',array('class'=>'input-medium','div'=>false,'label'=>false,'before'=>'<label style="float: left;">Legajo</label><span  class="field float">','after'=>'</span>'));
