...
var defaults = {
	...
	isRTL: false,
	firstDay: 0,
	monthNames: ['Enero3','February','March','April','May','June','July','August','September','October','November','December'],
...
function Calendar(element, options, eventSources) {
	...
	function reportEvents(_events,from) {
		events = _events;
		rerenderEvents(null,from);
	}
	...
	function rerenderEvents(modifiedEventID,from) {
		markEventsDirty();
		if (elementVisible()) {
			currentView.clearEvents();
			currentView.renderEvents(events, modifiedEventID,from);
			currentView.eventsDirty = false;
		}
	}
...
function AgendaEventRenderer() {
	...
	function renderEvents(events, modifiedEventId,from) {
		reportEvents(events);
